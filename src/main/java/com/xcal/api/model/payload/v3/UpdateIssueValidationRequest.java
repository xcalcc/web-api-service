...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(description = "UpdateIssueValidationRequest")
public class UpdateIssueValidationRequest {
    @ApiModelProperty(notes = "issue validation uuid", example = "d40029be-eda6-4d62-b1ef-d05e2e91a72a", required = true)
    UUID id;
