 ...
 * In version 081
 * - Format update
 * - Support repo action field
 * - Support commit id and baseline commit id
 */
public class CsfReaderV081 extends CsfReader {

    public static final String supportedMagic = "XC5";
    public static final String supportedVersion = "081";
    ...
    private static final int REPO_ACTION_FLAG_BYTE = 96;
    private static final int COMMIT_ID_OFFSET_STARTING_BYTE = 104;
    ...
    private static CsfReaderV081 instance = new CsfReaderV081();


    private CsfReaderV081() {
    }

    public static CsfReaderV081 getInstance() {
        return instance;
    }
    ...
    public String getRepoActionValue(RandomAccessFile issueFile) throws IOException {
        return getOffsetString(issueFile, REPO_ACTION_FLAG_BYTE, 1);
    }
